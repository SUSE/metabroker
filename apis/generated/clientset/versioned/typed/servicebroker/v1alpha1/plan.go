...
func newPlans(c *ServicebrokerV1alpha1Client, namespace string) *plans {
	return &plans{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *plans) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Plan, err error) {
...
func (c *plans) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PlanList, err error) {
...
func (c *plans) Create(ctx context.Context, plan *v1alpha1.Plan, opts v1.CreateOptions) (result *v1alpha1.Plan, err error) {
	result = &v1alpha1.Plan{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("plans").
...
func (c *plans) Update(ctx context.Context, plan *v1alpha1.Plan, opts v1.UpdateOptions) (result *v1alpha1.Plan, err error) {
	result = &v1alpha1.Plan{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("plans").
...
func (c *plans) UpdateStatus(ctx context.Context, plan *v1alpha1.Plan, opts v1.UpdateOptions) (result *v1alpha1.Plan, err error) {
	result = &v1alpha1.Plan{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("plans").
...
func (c *plans) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *plans) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Plan, err error) {
	result = &v1alpha1.Plan{}
