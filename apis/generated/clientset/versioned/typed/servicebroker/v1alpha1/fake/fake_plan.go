...
var plansResource = schema.GroupVersionResource{Group: "servicebroker", Version: "v1alpha1", Resource: "plans"}

var plansKind = schema.GroupVersionKind{Group: "servicebroker", Version: "v1alpha1", Kind: "Plan"}
...
func (c *FakePlans) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Plan, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(plansResource, c.ns, name), &v1alpha1.Plan{})
...
func (c *FakePlans) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PlanList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(plansResource, plansKind, c.ns, opts), &v1alpha1.PlanList{})
...
func (c *FakePlans) Create(ctx context.Context, plan *v1alpha1.Plan, opts v1.CreateOptions) (result *v1alpha1.Plan, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(plansResource, c.ns, plan), &v1alpha1.Plan{})
...
func (c *FakePlans) Update(ctx context.Context, plan *v1alpha1.Plan, opts v1.UpdateOptions) (result *v1alpha1.Plan, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(plansResource, c.ns, plan), &v1alpha1.Plan{})
...
func (c *FakePlans) UpdateStatus(ctx context.Context, plan *v1alpha1.Plan, opts v1.UpdateOptions) (*v1alpha1.Plan, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(plansResource, "status", c.ns, plan), &v1alpha1.Plan{})
...
func (c *FakePlans) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(plansResource, c.ns, name), &v1alpha1.Plan{})
...
func (c *FakePlans) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Plan, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(plansResource, c.ns, name, pt, data, subresources...), &v1alpha1.Plan{})
