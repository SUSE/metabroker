...
import (
	"github.com/SUSE/metabroker/apis/generated/clientset/versioned/scheme"
...
// ServicebrokerV1alpha1Client is used to interact with features provided by the servicebroker group.
type ServicebrokerV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ServicebrokerV1alpha1Client) Credentials(namespace string) CredentialInterface {
	return newCredentials(c, namespace)
}

func (c *ServicebrokerV1alpha1Client) Instances(namespace string) InstanceInterface {
	return newInstances(c, namespace)
}

func (c *ServicebrokerV1alpha1Client) Offerings(namespace string) OfferingInterface {
	return newOfferings(c, namespace)
}

func (c *ServicebrokerV1alpha1Client) Plans(namespace string) PlanInterface {
