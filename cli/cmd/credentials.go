...
func NewCredentialsCmd(
	...
	cmd.Flags().StringVarP(&namespace, "namespace", "n", "default", "The target namespace where the Credentials to be listed were created.")
	cmd.Flags().StringVar(&timeout, "timeout", "10s", "The time to wait for the Credentials to be listed.")
